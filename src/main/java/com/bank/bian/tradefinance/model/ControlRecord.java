package com.bank.bian.tradefinance.model;
...
/**
 * The BIAN control record for this service domain: "Trade Finance Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Trade Finance Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Trade Finance Facility Fulfillment Arrangement";
